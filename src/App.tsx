      ...
      <section id="zamowienia" className="py-16">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-3 text-neutral-700">Szybkie zamówienia prosto z Twojego telefonu – odbitki, fotoobrazy, kubki, kalendarze i więcej. Możliwy odbiór osobisty lub wysyłka kurierem.</p>
